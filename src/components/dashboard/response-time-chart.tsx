      ...
      <div className="p-5">
        {loading || !data ? (
          ...
          <BarChart
            ...
            index="day"
            categories={[CATEGORY]}
            // 'brand' maps to `fill-primary` (see chart-colors.ts), so
            // the bars are the BSign accent and follow the theme rather
            // than the fixed violet the hand-rolled bars used.
            colors={['brand']}
